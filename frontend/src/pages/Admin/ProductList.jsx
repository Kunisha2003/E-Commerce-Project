...
const ProductList = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      const uploadFileHandler = async (e) => {
        ...
        try {
          ...
          console.log(`http://localhost:5000${res.image}`);
      
          toast.success(res.message);
          setImage(e.target.files[0]);
          setImageUrl(`http://localhost:5000${res.image}`); // ✅ Corrected to include the path
        } catch (error) {
    ...
    <div className="container xl:mx-[9rem] sm:mx=[0]">
        ...
        <AdminMenu />
            <div className="md:w-3/4 p-3 ml-[5.5%]">
            ...
            <div className="flex flex-wrap">
              ...
              <div className="two ml-10 ">
                ...
                <input
                  type="number"
                  className="p-4 mb-3 w-[30rem] 
                  border rounded-lg bg-[#101011] text-white"
                  value={price}
            ...
            <button
              ...
              disabled={!name || !description || !price || !category || !quantity || !brand || !stock || !imageUrl}
